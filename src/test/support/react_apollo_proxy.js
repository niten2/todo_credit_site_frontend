...
function createApolloProxy(options) {
  ...
  var ApolloProxy = function (_Component) {
    ...
    function ApolloProxy(props) {
      ...
      var _this = (0, _possibleConstructorReturn3.default)(this, (ApolloProxy.__proto__ || Object.getPrototypeOf(ApolloProxy)).call(this, props));

      _this.client = new _reactApollo.ApolloClient({
        networkInterface: {
          query: function query(request) {
            return (0, _graphql.graphql)(schema, (0, _graphql.print)(request.query), rootValue, context, request.variables, request.operationName);
          }
        }
      });
      return _this;
    ...
    (0, _createClass3.default)(ApolloProxy, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          { client: this.client },
          _react2.default.createElement(NextProxy, (0, _extends3.default)({}, this.props, { nextProxy: next() }))
        );
      }
    }]);
    return ApolloProxy;
