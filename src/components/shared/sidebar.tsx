...
//   return props.pathname.indexOf(routeName)
//   > -1 ? 'nav-item nav-dropdown open pointer'
//   : 'nav-item nav-dropdown pointer'
// }
...
//                 </i> Dashboard <span className="badge badge-info">NEW</span>
//               </NavLink>
//             </li>
